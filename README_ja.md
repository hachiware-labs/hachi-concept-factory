...
最も強い課題の種を hachi-position で評価し、hachi-concept で磨いてください。
```
...
| `hachi-position` | 課題の種を、市場・競合・守りの強さ・最初の切り口の観点で進める価値があるか評価する | 位置づけ評価レポート |
...
| `hachi-position` | 位置づけ評価レポート、ベンダー / OSSリスク分析、守りの強さ / 最初の切り口のスコア、前進 / 保留 / 統合 / 却下の判断 | 課題の種を製品化に進めるべきか判断したい | `factory/positioning/` |
...
| `hachi-position` | 課題の種を次に進めるべきか判断する | `hachi-position: この課題の種を評価し、前進 / 保留 / 統合 / 却下を判断してください。`<br>`hachi-position: ベンダーリスク、OSSリスク、守りの強さ、最初の切り口、hachiware-labsとの相性を見てください。` |
...
「エージェントの記憶管理」の課題の種を集め、最も強いものを評価し、コンセプト概要へ洗練してください。
...
次に、最も強い課題の種を `hachi-position` に渡します。大手ベンダーに吸収されるリスク、OSS代替、手作業の回避策、差別化、守りの強さ、最初の切り口、作りやすさを評価します。この段階では、前進 / 保留 / 統合 / 却下の判断を出します。位置づけ評価レポートは `factory/positioning/` に保存します。
...
課題の種を見つけ、最も強い課題の種を評価し、コンセプト概要へ洗練し、
...
最も強い課題の種を hachi-position で評価し、hachi-concept でコンセプト概要へ洗練し、
...
`hachi-position` は、課題の種を製品仮説として進める価値があるかを判断するスキルです。
...
その後、最も強い課題の種を hachi-position で評価してください。
```
